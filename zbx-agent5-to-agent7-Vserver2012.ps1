...
$ZabbixServerIpCloud = "172.20.2.231"
$ZabbixServerIpLocal = "192.168.249.98"
$ZabbixServerDominioCloud = "zabbixcloud.dataunique.com.br"
...
function Configure-ZabbixAgent {
    ...
    (Get-Content $ZabbixConfig) -replace 'Server=127.0.0.1', "Server=${ZabbixServerIpCloud},${ZabbixServerIpLocal},192.168.249.1" |
    Set-Content $ZabbixConfig

    # Ajustar o IP do servidor Zabbix
    (Get-Content $ZabbixConfig) -replace 'ServerActive=127.0.0.1', "ServerActive=${ZabbixServerDominioCloud};${ZabbixServerDominioLocal}:${PORT}" |
    Set-Content $ZabbixConfig
